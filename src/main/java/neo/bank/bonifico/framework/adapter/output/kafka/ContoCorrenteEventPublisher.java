package neo.bank.bonifico.framework.adapter.output.kafka;
...
import neo.bank.bonifico.framework.adapter.output.kafka.integration_events.converters.IntegrationEventConverterFactory;
...
public class ContoCorrenteEventPublisher implements EventsPublisherPort {
    ...
    @Channel("bonifico-notifications")
