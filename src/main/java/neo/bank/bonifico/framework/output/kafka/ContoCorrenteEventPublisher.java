package neo.bank.bonifico.framework.output.kafka;
...
import neo.bank.bonifico.framework.output.kafka.integration_events.converters.IntegrationEventConverterFactory;
